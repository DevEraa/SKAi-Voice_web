                  ...
                  {currentRecords.map((user, index) => (
                    <tr key={index} className="hover:bg-gray-100 transition">
                      ...
                      <td className="px-6 py-4 text-center">
                        ...
                        >
                          {user.lcokstatus ? <Unlock size={20} /> : <Lock size={20} />}
                        </button>
          ...
          <div className="relative p-4 w-full max-w-md">
            <div className="relative bg-white rounded-lg shadow-lg">
              ...
              <div className="p-6 text-center">
                <svg
                  className={` mx-auto mb-4 ${!userToToggle?.lcokstatus ? "text-green-600" : "text-red-600"} w-14 h-14`}
                  fill="none"
                  stroke="currentColor"
                  viewBox="0 0 24 24"
                >
                ...
                <h3 className="mb-4 text-xl font-semibold text-gray-800">
                  {!userToToggle?.lcokstatus ? "Unlock Admin Access" : "Lock Admin Access"}
                </h3>
                <p className="mb-6 text-gray-600">
                  Are you sure you want to {!userToToggle?.lcokstatus ? "unlock" : "lock"} the admin{" "}
                  <span className="font-semibold">{!userToToggle?.lcokstatus}</span>?
                </p>
                <div className="flex justify-center space-x-4">
                  <button
                    className={`cursor-pointer px-6 py-2 text-white rounded-md transition-colors ${!userToToggle?.lcokstatus ? "bg-green-600 hover:bg-green-700" : "bg-red-600 hover:bg-red-700"
                      }`}
                    onClick={() => {
