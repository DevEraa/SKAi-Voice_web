                ...
                <div className="max-w-7xl mx-auto px-4">
                    <div className="flex justify-between items-center h-16">
                        ...
                        <div className="flex items-center space-x-4">
                            ...
                            <button onClick={() => setModalOpen(true)} className="hidden md:inline-flex items-center bg-blue-500 hover:bg-blue-600 text-white px-4 py-2 rounded-md text-sm font-medium transition-colors">
                                + New User
                            </button>

                            {/* User Profile - Desktop */}
                            <div className="hidden md:flex items-center space-x-2 cursor-pointer" onClick={() => setactivecard(!activecard)}>
                                <img
                        ...
                        <div className="px-6 py-4">
                            ...
                            <div className="space-y-4">
                                ...
                                <div className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                                    ...
                                    <span className="text-gray-700 font-medium">ritika@deveraa.com</span>
                                </div>
                                ...
                                <div className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                                    ...
                                    <span className="text-gray-700 font-medium">10 Users Limit</span>
                                </div>
                                ...
                                <div className="flex items-center space-x-3 p-2 hover:bg-gray-50 rounded-lg transition-colors">
                                    ...
                                    <span className="text-gray-700 font-medium">+977 9955221114</span>
                                </div>
                            </div>
